...
//				dc.setCapability("appActivity", "com.payvoo.app.ui.activity.TabActivity");
		     ...
		     WebElement helpandsupport = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/androidx.appcompat.widget.LinearLayoutCompat[6]/android.widget.CheckedTextView");
		     helpandsupport.click();
		     
		     /*
		     //email support
		     wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("in.rebase.app:id/support_email")));
		     WebElement email_support = driver.findElementById("in.rebase.app:id/support_email");
		     email_support.click();
		     wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.google.android.gm:id/subject")));
		     ...
		     WebElement write_email = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.widget.EditText");
		     write_email.click();
		     wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.google.android.gm:id/send")));
		     ...
		     */
		     ...
		     /*
		     //call us
		     wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("in.rebase.app:id/support_number")));
		     WebElement call_us = driver.findElementById("in.rebase.app:id/support_number");
		     call_us.click();
		     wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.google.android.dialer:id/dialpad_floating_action_button")));
		     ...
		     */
		     ...
		     WebElement chat_up = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/androidx.viewpager.widget.ViewPager/android.widget.FrameLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout");
		     chat_up.click();
		     wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("in.rebase.app:id/primary_action_text")));
		     WebElement chat1 = driver.findElementById("in.rebase.app:id/primary_action_text");
		     chat1.click();
